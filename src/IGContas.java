...
public class IGContas extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Titular: "+ Principal.conta1.getNome() + "\n"
                                          ...
                                          + "numero: "+ Poupanca.conta2.getNumero() +"\n"
                                          + "Conta Poupança: " + Poupanca.conta2.getSaldo() + "\n\n"
                
                                          + "Titular: "+ Especial.conta3.getNome() + "\n"
                                          + "numero: "+ Especial.conta3.getNumero() +"\n"
                                          + "Conta Especial: " + Especial.conta3.getSaldo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IGContas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
